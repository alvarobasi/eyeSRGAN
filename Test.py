...
def _map_fn(image_path):
    ...
    image_high_res = (image_high_res - 0.5) * 2 #Se comenta de forma temporal para super resolución.
...
if __name__ == "__main__":
    ...
    model_path_srgan = 'E:\\TFM\\outputs\\checkpoints\\SRGAN-VGG54\\generator_5000_34.6261.h5'
